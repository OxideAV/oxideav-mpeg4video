...
pub use vol::{
    ...
    AspectRatio, ColourDescription, SpriteEnable, SpriteWarpingAccuracy, VbvParameters,
    VideoSignalType, VisualObjectHeader, VolControlParameters, VolHeader, VolParseError,
